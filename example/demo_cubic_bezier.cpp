...
int main(){
    CubicBezier::Params cubic_params;

    cubic_params.x_start = 0;
    cubic_params.y_start = 0;
    cubic_params.x_inter1 = 1;
    cubic_params.y_inter1 = 2;
    cubic_params.x_inter2 = 2;
    cubic_params.y_inter2 = -2;
    cubic_params.x_end   = 3;
    cubic_params.y_end   = 0;
    cubic_params.dstep   = 0.03;
    CubicBezier Cubic(cubic_params);
